...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Nav Item - Item Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseCust"
               aria-expanded="true" aria-controls="collapseCust">
                <i class="fas fa-users"></i>
                <span>회원관리</span>
            </a>
            <div id="collapseCust" class="collapse" aria-labelledby="headingCust" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">회원관리:</h6>
                    <a class="collapse-item" href="<c:url value="/custList"/>">회원목록</a>
                    <a class="collapse-item" href="<c:url value="/custReg"/>">회원등록</a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseItem" class="collapse" aria-labelledby="headingItem" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<c:url value="/itemList"/>">상품목록</a>
                    <a class="collapse-item" href="<c:url value="/itemReg"/>">상품등록</a>
                    <div class="collapse-divider"></div>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseCharts" class="collapse" aria-labelledby="headingCharts" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">통계종류:</h6>
                    <a class="collapse-item" href="<c:url value="/charts1"/>">통계1</a>
                    <a class="collapse-item" href="<c:url value="/charts2"/>">통계2</a>
                    <a class="collapse-item" href="<c:url value="/charts3"/>">통계3</a>
                    <div class="collapse-divider"></div>
                </div>
            </div>
        </li>
